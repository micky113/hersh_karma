...
class KarmaVoiceImpl {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'do_good': {
      ...
      'Gujarati': 'સારું काम करो.',
      'Kannada': 'ಒಳ್ಳೆಯದನ್ನು ಮಾಡಿ.',
    ...
    'make_wish': {
      ...
      'Telugu': 'மீ கோரிக ஏமிடோ மாகு செப்பண்டி.',
      'Marathi': 'तुमची काय इच्छा आहे ते आम्हाला सांगा.',
      'Gujarati': 'તમારી ઈચ્છા અમને જણાવો.',
    ...
    'before_proof': {
      ...
      'Tamil': 'இப்போது எப்படி இருக்கிறது என்று ஒரு படம் எடுக்கவும்.',
      'Telugu': 'ప్రస్తుతం ఉన్న పరిస్థితిని ఫోటో తీయండి.',
      'Marathi': 'आताची परिस्थिती दर्शवणारा फोटो घ्या.',
      'Gujarati': 'અત્યારની स्थितिનો ફોટો લો.',
      'Kannada': 'ಈಗ ಹೇגಿದೆ ಎಂಬುದರ ਫೋಟೋ ತೆಗೆದುಕೊಳ್ಳಿ.',
      'Malayalam': 'ഇപ്പോഴത്തെ അവസ്ഥയുടെ ഫോട്ടോ എടുക്കുക.',
    ...
    'action_in_progress': {
      ...
      'Telugu': 'కార్यక్రమాన్ని పూర్తి చేయండి.',
    ...
    'after_proof': {
      ...
      'Gujarati': 'શું બદલાव આવ્યો છે તેનો ફોટો લો.',
      'Kannada': 'ಏನು ಬದಲಾವಣೆ ಆಗಿದೆ ಎಂಬುದರ ਫೋಟೋ ತೆಗೆದುಕೊಳ್ಳಿ.',
      'Malayalam': 'എന്ത് മാറ്റമാണ് ഉണ്ടായതെന്ന് കാണിക്കുന്ന ഫോട്ടോ എടുക്കുക.',
      'Punjabi': 'ਕੀ בਦਲਾਅ ਆਇਆ ਹੈ, ਉਸਦੀ ਇੱਕ ਫੋਟੋ ਲਓ।',
    ...
    'help_someone': {
      ...
      'Telugu': 'ఇతరుల కోరికకు సహాయం చేయండి.',
    ...
    'verification': {
      ...
      'Tamil': 'சரிபார்ப்பதற்கான ஆதாரத்தை சமர்ப்பிக்கவும்.',
      'Telugu': 'ధృవీకరణ కొరకు ఆధారాన్ని సమర్పించండి.',
      'Marathi': 'פדતાळणीसाठी पुरावा सादर करा.',
      'Gujarati': 'ચકાસણી માટે પુરાवा મોકલો.',
      'Kannada': 'ಪರಿಶೀಲನೆಗಾಗಿ ಪುרಾವೆಯನ್ನು ಸಲ್ಲಿಸಿ.',
