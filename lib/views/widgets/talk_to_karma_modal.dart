      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              _buildVoiceChip('🌱 Where can I do good?', 'Find deeds nearby'),
              _buildVoiceChip('🔎 Report garbage / कचरा', 'Report problem'),
              _buildVoiceChip('✨ How to make a wish?', 'Make a wish'),
              _buildVoiceChip('📊 What is my Karma?', 'Check passport'),
            ],
          ),
        ],
      ),
